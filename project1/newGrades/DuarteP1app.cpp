...
if (last ==3){
  cout << "Labs and Lab Exam Report" << endl;
  cout << setw (5) << left << "Type";
  cout << setw (5) << "Date";
  cout << setw (10) << right << "Score";
  cout << setw (10) << right << "Possible";
 ...
 overallscore += totalscore;
 overalltotal += totalpossible;
 totalpercentage += percentage*.65;
 cout << "Labs and Lab Exam percentage: " << setprecision(3) << percentage << "%" << endl << endl;
 //_________________________________________________________________________________
 //_________________________________________________________________________________

 //_________________________________________________________________________________
  cout << "Midterms and Final Report" << endl;
  cout << setw (5) << left << "Type";
  cout << setw (5) << "Date";
  cout << setw (10) << right << "Score";
  cout << setw (10) << right << "Possible";
 ...
 overallscore += totalscore;
 overalltotal += totalpossible;
 totalpercentage += percentage*.35;
 cout << "Midterms and Final Percentage: " << setprecision(3) << percentage << "%" << endl << endl;
  ...
  */
  ...
  if (overallgrade >= 90)
   cout << "Overall Percentage: " << setprecision(3) << overallgrade << "%" << "   Grade: " << a << endl;
  if (overallgrade >= 80 && overallgrade < 90)
   cout << "Overall Percentage: " << setprecision(3) << overallgrade << "%  " << "   Grade: " << b << endl;
  if (overallgrade >= 70 && overallgrade < 80)
   cout << "Overall Percentage: " << setprecision(3) << overallgrade << "%" << "   Grade: " << c << endl;
  if (overallgrade >= 60 && overallgrade < 70)
   cout << "Overall Percentage: " << setprecision(3) << overallgrade << "%  " << "   Grade: " << d << endl;
  if (overallgrade < 59)
   cout << "Overall Percentage: " << setprecision(3) << overallgrade << "%" << "   Grade: " << f << endl;
