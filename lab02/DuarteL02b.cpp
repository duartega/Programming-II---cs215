...
// Four  data values will be read from the standard input stream
...
int main()
{
  // These variables  will be used to store the current input value
  int v1;
  float v2;
  char v3;
  string v4;
  ...
  cin >> v1;
  cout << "The input values is " << v1 << "; the fail flag is ";
  if (cin.fail() == true)
    {
      cout << "true" << endl;
    }
